    ...
    return (
      <View>
        ...
        {drawerOptionSort({
          ...
          onPress: () => {
            props.navigation.closeDrawer();
            props.navigation.push("SelectCab");
        ...
        {drawerOptionSort({
          ...
          onPress: () => {
            props.navigation.closeDrawer();
            props.navigation.push("MiddlemanContactUs");
          },
        })}
        {divider()}
        {drawerOptionSort({
      ...
      <View style={styles.headerWrapStyle}>
        <View>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              props.navigation.closeDrawer();
              props.navigation.push("EditMiddlemanProfile");
            }}
...
export default MiddlemanDrawer;
